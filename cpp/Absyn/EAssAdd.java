...
public class EAssAdd extends Exp {
  public final Exp exp_1, exp_2;
  public EAssAdd(Exp p1, Exp p2) { exp_1 = p1; exp_2 = p2; }

  public <R,A> R accept(cpp.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof cpp.Absyn.EAssAdd) {
      cpp.Absyn.EAssAdd x = (cpp.Absyn.EAssAdd)o;
